let menEl = document.getElementById("men-category");
let womenEl = document.getElementById("women-category");
let kidsEl = document.getElementById("kids-category");
...
function createProductCard(product){
    ...
    productDetail.appendChild(titleEl);
    
    const vendor = document.createElement('li');
    vendor.textContent = `${product.vendor}`;
    vendor.className = "vendor";
    productDetail.appendChild(vendor);
    
    const divEl = document.createElement("div");
    divEl.className = "div-card";
    productDetail.appendChild(divEl);
    ...
    if(product.compare_at_price){
        ...
        divEl.appendChild(comparePrice);
        ...
        divEl.appendChild(discountPercentage);
    }
    
    const addButton = document.createElement('button');
    addButton.textContent = "Add to Cart";
    addButton.className = "button";
    productDetail.appendChild(addButton);
    cardEl.appendChild(productDetail);
    return cardEl;
    
}  

function displayProductCard(categoryName){
    womenEl.style.backgroundColor = "#000";
    womenEl.style.color = "white";
    const productContainerEl = document.getElementById("productContainer");
    productContainerEl.innerHTML = '';
    
    
    const category = productData.categories.find(category => category.category_name === categoryName);
   ...
   if(category){
       ...
       if (categoryName === "Men"){
        menEl.style.backgroundColor = 'black';
        menEl.style.color = "white";
        womenEl.style.backgroundColor = "#e0e0e0";
        womenEl.style.color = "black";
        kidsEl.style.backgroundColor = "#e0e0e0";
        kidsEl.style.color ="black"; 
       }else if (categoryName === "Women"){
        womenEl.style.backgroundColor = "black";
        womenEl.style.color = "white";
        menEl.style.backgroundColor = '#e0e0e0';
        menEl.style.color = "black";
        kidsEl.style.backgroundColor = "#e0e0e0";
        kidsEl.style.color ="black"; 
       }else if (categoryName === "Kids"){
        kidsEl.style.backgroundColor = "black";
        kidsEl.style.color ="white"; 
        menEl.style.backgroundColor = '#e0e0e0';
        menEl.style.color = "black";
        womenEl.style.backgroundColor = "#e0e0e0";
        womenEl.style.color = "black";
...
function showCategory(categoryName){
    displayProductCard(categoryName);
}    
displayProductCard("women");
